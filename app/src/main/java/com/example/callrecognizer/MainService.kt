...
class ForegroundService : Service() {
    ...
    val defaultNotification = {
        NotificationCompat.Builder(this, getChannel())
            ...
            .setSmallIcon(R.drawable.ic_round_sports_motorsports)
            .setPriority(NotificationCompat.PRIORITY_MIN) // maybe a different priority to be less intrusive
